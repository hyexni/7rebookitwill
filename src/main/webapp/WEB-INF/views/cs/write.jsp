...
<main class="main-content">
	<div class="jw-container" style="max-width:700px; margin:50px auto;">
	  <h1>1:1 문의 작성</h1>
	  ...
	  <form action="${pageContext.request.contextPath}/cs/write" method="post">
	    ...
	    <!-- ▣ 버튼 -->
	    <div class="btn-jw-wrapper">
	      <button type="submit" class="btn-jw-blue" style="text-area: right;">문의 접수</button>
	      <a href="${pageContext.request.contextPath}/cs/list" class="btn-jw-gray">과거 1:1문의 확인</a>
	    </div>
	  </form>
	</div>
</main>
