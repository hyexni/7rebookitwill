...
<main class="main-content">
	<div class="admin-container" id="member-list">	
		  ...
		  <!-- 🔍 검색 & 정렬 -->
		<form action="${cpath}/admin/member_list" method="get" class="search-form">
		  <!-- 🔍 검색창만 남김 -->
		      ...
		      <tr>
		        <!-- 가입일 정렬 -->
			      <th style="width: 10%;">
			        ...
			        <a href="${pageContext.request.contextPath}/admin/member_list?page=1&sort=regdate&dir=${toggleDir}
			        			&keyword=${fn:escapeXml(keyword)}#member-list"
		        ...
		        <th style="width: 12%;">닉네임</th>
		         ...
		         <!-- 이름 정렬 -->
			      <th style="width: 12%;">
			        ...
			        <a href="${pageContext.request.contextPath}/admin/member_list?page=1&sort=name&dir=${toggleDir}
			        			&keyword=${fn:escapeXml(keyword)}#member-list"
		        ...
		        <!-- 포인트 정렬 -->
			      <th  style="width: 9%;">
					  ...
					  <a href="${pageContext.request.contextPath}/admin/member_list?page=1&sort=point&dir=${toggleDir}
					  			&keyword=${fn:escapeXml(keyword)}#member-list"
		  ...
		  <!-- 페이지네이션 버튼 -->
			<div class="pagination">
			  <a href="${pageContext.request.contextPath}/admin/member_list?page=${currentPage - 1}
			  			&sort=${sort}&dir=${dir}&keyword=${keyword}#member-list"
